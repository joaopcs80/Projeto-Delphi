...
begin
  shpAlterar.Brush.Color := clHtmLightGoldenrod1;
end;

 procedure TfrmAlterarSenha.lblAcessarMouseMove(Sender: TObject; Shift: TShiftState; X, Y: Integer);
begin
  shpAlterar.Brush.Color := clHtmGold1;
end;

procedure TfrmAlterarSenha.lblFecharMouseLeave(Sender: TObject);
begin
  shpFechar.Brush.Color :=clHtmFirebrick2;
end;

procedure TfrmAlterarSenha.lblFecharMouseMove(Sender: TObject; Shift: TShiftState; X, Y: Integer);
begin
